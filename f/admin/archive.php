...
<div id="content">
    ...
    <ul class="list-group mt-5 mb-5">
        <li class="list-group-item p-4">
            ...
            <a href="<?php echo isset($_GET['search']) ? '../admin/archive.php' : '../admin/aDashboard.php'; ?>" class="text-decoration-none">
            ...
            <?php foreach ($studies as $study): ?>
                <ul style="list-style-type: none;" class="p-3 rounded ulInside mb-4 mt-3">
                    ...
                    <a href="../admin/display_arch.php?id=<?php echo $study['id']; ?>">
                    <?php $title = $study['title'];
                        ...
                        <div class="ml-auto">
                            <!-- Delete btn -->
                            <button type="submit" class="btn btn-link text-secondary" title="Delete" data-bs-toggle="modal" data-bs-target="#deleteModal_<?php echo $study['id']; ?>">
