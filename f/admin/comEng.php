...
<div id="content">
    ...
    <form class="search" action="" method="GET">
        <input type="text" autocomplete="off" class="form-control" name="search" placeholder="Search for a study" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
    ...
    <ul class="list-group mt-5 mb-5">
        <li class="list-group-item p-4">
            <h3 class="text-muted">Studies from Computer Engineering</h3>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" autocomplete="off" name="title" class="form-control" id="title" value="<?php echo $study['title']; ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="authors" class="col-form-label" style="font-size: 17px;">Authors</label>
                                                <input type="text" autocomplete="off" name="authors" class="form-control" id="authors" value="<?php echo $study['authors']; ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="abstract" class="col-form-label" style="font-size: 17px;">Abstract</label>
                                                <textarea class="form-control abstract" autocomplete="off" name="abstract" id="abstract" style="height: 330px;"><?php echo $study['abstract']; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" autocomplete="off" name="saveChanges" class="btn btn-warning addbtn">Save changes</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
